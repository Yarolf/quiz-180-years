...
async def process_test_command(message: types.Message):
    ...
    await __send_not_answered_question_or_refuse(message, answered_question)


async def __send_not_answered_question_or_refuse(message, answered_question):
    try:
        await __send_not_answered_question(message, answered_question)
